...
//
//  File:       Matrix3.h
//  Content:    The 3x3 matrix class.
//  $Id:        Matrix3.h 101 2010-03-01 20:43:38Z agray $
//
//////////////////////////////////////////////////////////////////////////////
...
#ifndef __ZSPACE_MATRIX3_H__
#define __ZSPACE_MATRIX3_H__
...
*/
    ...
    */
    class ZSPACE_COMMON_API Matrix3
    {
    public:
        /** Default constructor.
            @note
                This constructor does <b>NOT</b> initialize the matrix for efficiency.
        */
		inline Matrix3 () {};
		...
		*/
        ...
        ZSPACE_COMMON_API friend Vector3 operator* (const Vector3& rkVector,
        ...
        // scalar * matrix
        ZSPACE_COMMON_API friend Matrix3 operator* (float fScalar, const Matrix3& rkMatrix);
		...
		/** Determines if this matrix involves scaling. */
