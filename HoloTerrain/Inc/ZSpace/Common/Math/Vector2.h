...
//
//  File:       Vector2.h
//  Content:    The Vector2 class.
//  $Id:        Vector2.h 101 2010-03-01 20:43:38Z agray $
//
//////////////////////////////////////////////////////////////////////////////
...
#ifndef __ZSPACE_VECTOR2_H__
#define __ZSPACE_VECTOR2_H__
...
*/
	...
	/** Standard 2-dimensional vector.
        @remarks
            A direction in 2D space represented as distances along the two
            orthogonal axes (<i>x</i>, <i>y</i>). Note that positions, directions and
            scaling factors can be represented by a vector depending on how
            you interpret the values.
    */
    class ZSPACE_COMMON_API Vector2
    {
    public:
        float x, y;
    ...
    public:
		...
		*/
        ...
        {
            ZS_ASSERT(0x000000e7, i < 2, "Out-of-bounds element requested from Vector2.");
        ...
        {
            ZS_ASSERT(0x000000e8, i < 2, "Out-of-bounds element requested from Vector2.");
        ...
        */
        ...
        inline Vector2 operator / ( const float fScalar ) const
        {
            ZS_ASSERT(0x000000e9, fScalar != 0.0, "Vector2 divide-by-zero.");
        ...
        inline Vector2& operator /= ( const float fScalar )
        {
            ZS_ASSERT(0x000000ea, fScalar != 0.0, "Vector2 divide-by-zero.");
        ...
        */
        ...
        /** Calculates the dot (scalar) product of this vector with another.
            @remarks
                The dot product can be used to calculate the angle between two
        ...
        */
        ...
        /** Calculates the 2 dimensional cross-product of two vectors, which results
			in a single floating point value which is two times the area of the triangle.
        */
