...
//
//  File:       Vector4.h
//  Content:    The Vector4 class.
//  $Id:        Vector4.h 101 2010-03-01 20:43:38Z agray $
//
//////////////////////////////////////////////////////////////////////////////
...
#ifndef __ZSPACE_VECTOR4_H__
#define __ZSPACE_VECTOR4_H__
...
*/
	...
	/** This is a 4-dimensional homogeneous vector.
    */
    class ZSPACE_COMMON_API Vector4
    {
    public:
        float x, y, z, w;
    ...
    public:
		...
		*/
        ...
        {
            ZS_ASSERT(0x000000ef, i < 4, "Out-of-bounds element requested from Vector4.");
        ...
        {
            ZS_ASSERT(0x000000f0, i < 4, "Out-of-bounds element requested from Vector4.");
        ...
        */
        ...
        inline Vector4 operator / ( const float fScalar ) const
        {
            ZS_ASSERT(0x000000f1, fScalar != 0.0, "Vector4 divide-by-zero.");
        ...
        inline Vector4& operator /= ( const float fScalar )
        {
            ZS_ASSERT(0x000000f2, fScalar != 0.0, "Vector4 divide-by-zero.");
        ...
        */
        ...
        // X, Y, Z, W values of Vector4 map to Red, Green, Blue, Alpha values of the color
