...
#ifndef EG_CONFIGWRITERINT_HPP_INCLUDED
#define EG_CONFIGWRITERINT_HPP_INCLUDED
...
namespace EbonGL
{
    class EG_ConfigWriterInt
    {
        public:
            //constructor
            EG_ConfigWriterInt(void);
        ...
        private:
            ...
            static bool readEntry(std::string oneLine,
                                  ...
                                  const std::string &configID,
                                  const std::string &newString,
                                  std::vector <EG_ConfigComments*> &fileComments,
                                  std::vector <std::string> &fileIDs,
                                  std::vector <std::string> &fileValues,
                                  const std::string &pathAndName);

            //Write the file name and configID to log file. Used to report errors
            //in file entries.
            static void writeFileAndLabel(const std::string &pathAndName,
                                          const std::string &configID);
    };//EG_ConfigWriterInt
}//namespace EbonGL
